...
echo "Criando grunpos" 

groupadd GRP_ADM
groupadd GRP_VEN
groupadd GRP_SEC

echo "Criando usuarios e adicioando ao seu respequetivo grupo"
...
echo "Epecificando os prproestarios dos diretorios"

chown root:GRP_ADM /adm
chown root:GRP_VEN /ven
chown root:GRP_SEC /sec

echo "Atrebuindo permiçoes aos usuarios aos seus diretorios"
